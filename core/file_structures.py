...
from core.sets import SetDataFormat
...
class SetFileStructure:
    ...
    def __init__(self, path: str,
        ...
        self.__file_format: SetDataFormat = file_format
    ...
    @classmethod
    def get_canonical(self, path: str,
                      set_name: str,
                      file_format: SetDataFormat):
        ...
        Args:
            ...
            file_format (SetDataFormat): data file format
...
class CorpusFileStructure:
    def __init__(self,
                 ...
                 file_format: SetDataFormat = SetDataFormat.NPY):
    ...
    def get_canonical(cls,
        ...
        test_file_structrure = \
            SetFileStructure.get_canonical(path=test_path, set_name=training_set_name, file_format=file_format)
